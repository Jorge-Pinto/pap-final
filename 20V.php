...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <body>
    ...
    <div class="container" style="background-color: rgb(214, 214, 214);">
      <div class="row">
        <div class="col-lg" style="margin-right: 50px;">
                ...
                <model-viewer id="hola" src="./3Dporsche-911/scene.gltf" alt=" A Range-Rover-Evoque"  auto-rotate camera-controls></model-viewer>
    ...
    <div class="col-lg">
      ...
      <div style="margin-top: 108px;" class="card">
        <div class="card-body">
          <ul>
