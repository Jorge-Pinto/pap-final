...
<html lang="en">
  ...
  <section class="py-5">
    <div class="container">
      <h1 class="display-4">La Gama SUB </h1> 
      <p class="lead">La actual oferta de Todoterrenos de Peugeot cuenta con modelos en los segmentos más demandados del mercado.</p>
    </div>
  </section>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/peugeot3008.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <ul class="list-group">
                        <li id="cartaA" class="list-group-item"><h4 class="card-title">Peugeot 3008</h4></li>
                        <li id="cartaA" class="list-group-item">Suv Totalmente Equipado</li>
                    ...
                    <a href="./12V.php" class="btn btn-danger">Acceder al modelo</a>
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/peugeot5008.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <ul class="list-group">
                        <li id="cartaA" class="list-group-item"><h4 class="card-title">Peugeot 5008</h4></li>
                        <li id="cartaA" class="list-group-item">Suv 7 Plazas</li>
                        <li id="cartaA" class="list-group-item">5 Puertas</li>
                    ...
                    <a href="./19V.php" class="btn btn-danger">Acceder al modelo</a>
