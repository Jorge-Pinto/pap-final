...
<html lang="en">
    <head>
        ...
        <link href="css/styleporsche.css" rel="stylesheet" />
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('./assets/img/logoporsche.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <p class="lead"> Vehículos de máxima potencia, manteniendo la elegancia.</p>
          </div>
        </div>
        <!-- Slide Three - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('./assets/img/cochesporsche.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <p class="lead"> Disfruta de nuestra marca, disfrutra de la velocidad.</p>
          </div>
        </div>
      </div>
  ...
  <section class="py-5">
    <div class="container">
      <h1 class="display-4">La Gama Carrera </h1> 
      <p class="lead">La gama Carrera supone tanto una retrospectiva como una visión de futuro para la marca de Stuttgart. La silueta es icónica. El diseño, como no, atemporal. La ingeniería y tecnología a bordo se inspira en las victorias de Porsche en competición y miran hacia el futuro.</p>
    </div>
  </section>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/porsche911.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <ul class="list-group">
                        <li id="cartaA" class="list-group-item"><h4 class="card-title">Porsche 911 Hibrid</h4></li>
                        <li id="cartaA" class="list-group-item">Gama Carrera</li>
                    ...
                    <a href="./20V.php" class="btn btn-danger">Acceder al modelo</a>
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/porsche356.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <ul class="list-group">
                        <li id="cartaA" class="list-group-item"><h4 class="card-title">Porsche 356</h4></li>
                        <li id="cartaA" class="list-group-item">Clásico Carrera</li>
                    ...
                    <a href="./15V.php" class="btn btn-danger">Acceder al modelo</a>
