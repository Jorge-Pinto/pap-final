...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <div class="container">
      ...
      <h3 style="margin-left: 100px; color: white;">Registros de Pieza por Pieza</h3>
                ...
                $con=conexion("pap");
                $accion="SELECT table_name AS nombre
                FROM information_schema.tables WHERE table_schema = 'pap';";
                ...
                $cantidad= mysqli_num_rows($result);
                        ...
                        echo "<tr><td><a style='color: white' href='./mostrarAdmin.php?tabla=$datos[nombre]'>$datos[nombre]</a></td></tr> ";
...
<div id="footer" style="margin-top: 155px"></div>
