...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('./assets/img/ruedasfondo.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <p class="lead"> Ruedas deportivas, para tus vehículos preferidos.</p>
          </div>
        </div>
        <!-- Slide Three - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('./assets/img/ruedasfondo2.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <p class="lead"> Los mejores neumáticos de las mejores marcas.</p>
          </div>
        </div>
      </div>
  ...
  <section class="py-5">
    <div class="container">
      <h1 class="display-4">Las Mejores Ruedas para tu vehículo</h1> 
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/mabdulwheels.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <ul class="list-group">
                        <li id="cartaA" class="list-group-item"><h4 class="card-title">Mabdul Wheels 7.0</h4></li>
                    ...
                    <a href="./22P.php" class="btn btn-danger">Acceder al modelo</a>
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/mugenwheel.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                  <ul class="list-group">
                    <li id="cartaA" class="list-group-item"><h4 class="card-title">Mugen Wheel X1</h4></li>
                    ...
                    <a href="./30P.php" class="btn btn-danger">Acceder al modelo</a>
