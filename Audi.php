...
<html lang="en">
    <head>
        ...
        <link href="css/styleaudi.css" rel="stylesheet" />
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('./assets/img/logoaudi.jpg')">
  ...
  <section class="py-5">
    <div class="container">
      <h1 class="display-4">La Gama RS </h1> 
      <p class="lead">La gama más deportiva y extrema de la marca de los cuatro aros. Ello ofrece una carta de presentación suficientemente contundente en unos vehículos que comparten deportividad de altas prestaciones y máxima eficacia, aunque sin renunciar a la versatilidad y comodidad.</p>
    </div>
  </section>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/audirs5.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <ul class="list-group">
                        <li id="cartaA" class="list-group-item"><h4 class="card-title">Audi RS5</h4></li>
                    ...
                    <a href="./10V.php" class="btn btn-danger">Acceder al modelo</a>
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/audirs7.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <ul class="list-group">
                        <li id="cartaA" class="list-group-item"><h4 class="card-title">Audi RS7</h4></li>
                        <li id="cartaA" class="list-group-item">Deportivo Coupé</li>
                    ...
                    <a href="./18V.php" class="btn btn-danger">Acceder al modelo</a>
