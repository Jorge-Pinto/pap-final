      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <script>
          ...
          function infoaudirs5(){
            var marca="Range Rover Sport Svr";
            var peticion = $.ajax({
            url: "sacars5.php",
            type: "POST",
    ...
    <div class="container" style="background-color: rgb(214, 214, 214);">
      <div class="row">
        <div class="col-lg" style="margin-right: 50px;">
                ...
                <model-viewer id="hola" src="./3Droversrv/scene.gltf" alt=" A Range-Rover-Evoque"  auto-rotate camera-controls></model-viewer>
