    ...
    <div class="container" style="background-color: rgb(214, 214, 214);">
      <div class="row">
        <div class="col-lg" style="margin-right: 50px;">
                ...
                <model-viewer id="hola" src="./3Dmotor/scene.gltf" alt=" A Range-Rover-Evoque"  auto-rotate camera-controls></model-viewer>
