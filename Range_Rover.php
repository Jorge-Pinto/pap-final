...
session_start();
$_SESSION["pagina"]="Range_Rover.php";
...
<html lang="en">
    <head>
        ...
        <link href="css/stylerangerover.css" rel="stylesheet" />
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('./assets/img/logorangerover.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <p class="lead"> Los subs mas deportivos de todo el mercado.</p>
          </div>
        </div>
        <!-- Slide Three - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('./assets/img/cochesrangerover.png')">
          <div class="carousel-caption d-none d-md-block">
            <p class="lead"> Potencia para disfrutar con tu familia.</p>
          </div>
        </div>
      </div>
  ...
  <section class="py-5">
    <div class="container">
      <h1 class="display-4">La Gama Todoterreno SVR </h1> 
      <p class="lead">La gama Todoterreno más potente lleva como apellido SVR, la parte más deportiva de la marca, siendo el Land Rover más rápido de todos los tiempos.</p>
    </div>
  </section>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/rangeroversvr.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <ul class="list-group">
                        <li id="cartaA" class="list-group-item"><h4 class="card-title">Range Rover SVR 2020</h4></li>
                        <li id="cartaA" class="list-group-item">Todoterreno SVR</li>
                    ...
                    <a href="./11V.php" class="btn btn-danger">Acceder al modelo</a>
        ...
        <div class="col-lg-6">
            ...
            <div class="card img-fluid" style="width:500px">
                <img class="card-img-top" src="./assets/img/rangeroverevoque.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    <ul class="list-group">
                        <li id="cartaA" class="list-group-item"><h4 class="card-title">Range Rover Evoque</h4></li>
                        <li id="cartaA" class="list-group-item">Todoterreno SVR</li>
                        <li id="cartaA" class="list-group-item">5 Puertas</li>
                        <li id="cartaA" class="list-group-item">Colores Disponibles: <div style="display:inline-flex;"><div id="color1"></div>
                            <div id="color2"></div>
                    ...
                    <a href="./16V.php" class="btn btn-danger">Acceder al modelo</a>
